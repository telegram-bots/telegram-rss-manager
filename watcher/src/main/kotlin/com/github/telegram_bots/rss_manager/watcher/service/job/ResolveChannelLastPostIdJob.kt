...
import com.github.telegram_bots.rss_manager.watcher.service.TelegramClientSupplier
import io.reactivex.Single
import io.reactivex.functions.Function

class ResolveChannelLastPostIdJob(private val clientSupplier: TelegramClientSupplier) : Function<Channel, Single<Channel>> {
    override fun apply(channel: Channel): Single<Channel> = Single.defer {
        val client = clientSupplier.getClient()
        Single.just(channel)
